...
# cnx = mysql.connector.connect(user='root', password='9711917499',
#                               host='localhost',
#                               database='twitter')
# cursor=cnx.cursor()
...
#            print "here",
        ...
        # try:
        #     cursor.execute("INSERT INTO movie (tweet, created_at, username, favourite_count, place, hashtags, urls,movie_name) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)",
        #         (tweet, created_at, username, favourites, place, all_hashtags, all_urls,movie_name))
